...
export interface IProfessorRegistrationHandler {
  createProfessorAccount: (req: httpRequest) => any;
  submitPersonalInfo: (req: httpRequest) => any;
}

class ProfessorRegistrationHandler implements IProfessorRegistrationHandler {
...
export default ProfessorRegistrationHandler;
